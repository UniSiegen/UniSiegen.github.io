...
```bash
[you@laptop:~]$ scp local_file username@omni.zimt.uni-siegen.de:remote_destination
```
...
```bash
[you@laptop:~]$ scp amdahl.tar.gz username@omni.zimt.uni-siegen.de:
```

:::::::::::::::::::::::::::::::::::::::  challenge

## Why Not Download on OMNI Cluster Siegen Directly?
...
[username@hpc-login02 ~]$ wget -O amdahl.tar.gz https://github.com/hpc-carpentry/amdahl/tarball/main
# or
[username@hpc-login02 ~]$ curl -o amdahl.tar.gz https://github.com/hpc-carpentry/amdahl/tarball/main
```
...
```bash
[you@laptop:~]$ scp -r amdahl username@omni.zimt.uni-siegen.de:
```
...
```bash
[you@laptop:~]$ rsync -avP amdahl.tar.gz username@omni.zimt.uni-siegen.de:
```
...
```bash
[you@laptop:~]$ rsync -avP amdahl username@omni.zimt.uni-siegen.de:~/
```
...
```bash
[you@laptop:~]$ rsync -avP username@omni.zimt.uni-siegen.de:amdahl ./
```
...
```bash
[you@laptop:~]$ rsync amdahl.tar.gz username@omni.zimt.uni-siegen.de:
```
...
[you@laptop:~]$ rsync --port=768 amdahl.tar.gz username@omni.zimt.uni-siegen.de:
```
...
- Host: `sftp://omni.zimt.uni-siegen.de`
